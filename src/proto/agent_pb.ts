...
export type SubagentRunState = Message<"agent.v1.SubagentRunState"> & {
   ...
   */
  completedTimestampMs?: bigint | undefined;

  /**
   * @generated from field: optional agent.v1.BackgroundTaskCompletionReason completion_reason = 10;
   */
  completionReason?: BackgroundTaskCompletionReason | undefined;
};
...
/**
 * @generated from message agent.v1.GoalState
 */
export type GoalState = Message<"agent.v1.GoalState"> & {
  /**
  ...
  /**
   * @generated from field: agent.v1.GoalStatus status = 4;
   */
  status: GoalStatus;

  /**
   * @generated from field: uint32 idle_continuations_without_tool_calls = 5;
   */
  idleContinuationsWithoutToolCalls: number;

  /**
   * @generated from field: optional uint64 active_duration_ms = 6;
   */
  activeDurationMs?: bigint | undefined;

  /**
   * @generated from field: optional uint64 last_accrued_at_ms = 7;
   */
  lastAccruedAtMs?: bigint | undefined;

  /**
   * @generated from field: uint32 continuation_count = 8;
   */
  continuationCount: number;

  /**
   * @generated from field: optional string agent_session_id = 9;
   */
  agentSessionId?: string | undefined;
};

/**
 * Describes the message agent.v1.GoalState.
...
export type ConversationStateStructure = Message<"agent.v1.ConversationStateStructure"> & {
  ...
  /**
   * Cursor 3.15.6 names field 21 tracked_git_repo_branches and field 22
   * agent_type. Keep extra_state/client_name: outbound request-build and
   * selectedContextBlob encode client identity on field 22 (`clientName: "pi"`).
   *
  ...
  /**
   * @generated from field: map<string, bytes> subagent_state_refs = 31;
   */
  subagentStateRefs: { [key: string]: Uint8Array };

  /**
   * @generated from field: optional agent.v1.GoalState goal_state = 32;
   */
  goalState?: GoalState | undefined;

  /**
   * @generated from field: optional bool is_root_project_conversation = 33;
   */
  isRootProjectConversation?: boolean | undefined;

  /**
   * Cloud-only VARINT on live/persisted checkpoints (values 4–74). Absent from
   * Cursor.app 3.15.6 workbench (schema ends at 33). Name unrecovered.
   * Field 34 is live-stream only; leave it in $unknown until its wire type is captured.
   *
   * @generated from field: optional uint64 unknown_field_37 = 37;
   */
  unknownField37?: bigint | undefined;

  /**
   * Live-stream only (2026-09-21 captures): field 38 is a length-delimited value,
   * constant within a session (37 bytes) and differing across sessions — session
   * identity or a per-conversation token. Field 39 is a VARINT, observed value 1.
   * Names unrecovered; recovered so $unknown stops flagging every checkpoint.
   *
   * @generated from field: optional bytes unknown_field_38 = 38;
   */
  unknownField38?: Uint8Array | undefined;

  /**
   * @generated from field: optional uint64 unknown_field_39 = 39;
   */
  unknownField39?: bigint | undefined;
};
...
export type InteractionUpdate = Message<"agent.v1.InteractionUpdate"> & {
  ...
  /**
   * @generated from field: uint64 timestamp_ms = 25;
   */
  timestampMs: bigint;
};
...
export type ExecServerMessage = Message<"agent.v1.ExecServerMessage"> & {
  ...
  /**
   * Live-stream captures (2026-09-21) show two further exec cases this build has
   * no branch for: field 28 (length-delimited, 213 bytes) and field 36
   * (length-delimited, 1–5 bytes). Content is not safely decodable from the
   * captured metadata alone, so they stay $unknown and keep the
   * ExecClientThrow answer; recorded here so the drift is documented.
   *
...
/**
 * @generated from enum agent.v1.GoalStatus
 */
export enum GoalStatus {
  ...
  /**
   * @generated from enum value: GOAL_STATUS_COMPLETE = 3;
   */
  COMPLETE = 3,

  /**
   * @generated from enum value: GOAL_STATUS_CLEARED = 4;
   */
  CLEARED = 4,
}

/**
 * Describes the enum agent.v1.GoalStatus.
 */
